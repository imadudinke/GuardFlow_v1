...
export default function DocsPage() {
  ...
  const CodeBlock = ({ children, language = 'bash', id }: { children: string, language?: string, id: string }) => (
    <div className="relative retro-card-static bg-black text-green-400 p-4 my-4 font-mono text-sm overflow-x-auto">
      <div className="flex items-center justify-between mb-2 pb-2 border-b border-green-800">
        <span className="text-xs text-green-600 uppercase tracking-wide">{language}</span>
        <button
          onClick={() => copyToClipboard(children, id)}
          className="flex items-center gap-1 text-xs text-green-600 hover:text-green-400 transition-colors"
        >
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            <Link href="/" className="flex items-center gap-3">
              <div className="retro-card bg-black p-2">
            ...
            <div className="flex items-center gap-4">
              <Link href="/login" className="retro-button bg-white text-black border-black px-6 py-2 hover:bg-gray-50">
                <span className="font-black retro-mono text-sm">LOGIN</span>
              </Link>
              <Link href="/register" className="retro-button bg-black text-white border-black px-6 py-2 hover:bg-gray-900">
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-12">
            <div className="inline-block retro-card bg-blue-100 border-black px-6 py-2 mb-6">
              <span className="font-black retro-mono text-sm">DNA-BASED THREAT DETECTION</span>
            </div>
            <h1 className="text-6xl font-black retro-title text-black mb-6">
              GUARDFLOW<br/>
            ...
            <div className="max-w-2xl mx-auto">
              <div className="retro-card bg-black text-green-400 p-6">
                <div className="flex items-center justify-between">
                  ...
                  <button 
                    ...
                    className="retro-button bg-green-600 text-white border-green-800 px-4 py-2 hover:bg-green-700"
                  >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
            {[
              ...
              <div key={i} className="retro-card bg-white border-black p-4 text-center">
      ...
      {/* Navigation Tabs */}
      <section className="bg-gray-100 border-y-4 border-black sticky top-20 z-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section id="quick-start" className="mb-20">
          <div className="retro-card bg-blue-50 border-black p-2 inline-block mb-6">
            <h2 className="text-4xl font-black retro-title text-black flex items-center gap-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="retro-card bg-blue-50 border-black p-6">
              <div className="retro-card bg-blue-600 text-white border-black w-16 h-16 flex items-center justify-center mb-4">
                <span className="text-4xl font-black retro-title">1</span>
              </div>
              <h3 className="text-xl font-black retro-title text-black mb-3">INSTALL SDK</h3>
              <CodeBlock language="bash" id="step1">pip install guardflow-fastapi</CodeBlock>
            </div>

            <div className="retro-card bg-green-50 border-black p-6">
              <div className="retro-card bg-green-600 text-white border-black w-16 h-16 flex items-center justify-center mb-4">
                <span className="text-4xl font-black retro-title">2</span>
              </div>
              <h3 className="text-xl font-black retro-title text-black mb-3">START REDIS</h3>
              <CodeBlock language="bash" id="step2">docker run -d -p 6379:6379 redis:alpine</CodeBlock>
            </div>

            <div className="retro-card bg-purple-50 border-black p-6">
              <div className="retro-card bg-purple-600 text-white border-black w-16 h-16 flex items-center justify-center mb-4">
                <span className="text-4xl font-black retro-title">3</span>
              </div>
              <h3 className="text-xl font-black retro-title text-black mb-3">ADD MIDDLEWARE</h3>
              <p className="text-sm font-mono text-gray-600">See code below →</p>
            </div>
          </div>

          <div className="retro-card bg-white border-black p-6">
            <h3 className="text-xl font-black retro-title text-black mb-4">COMPLETE EXAMPLE</h3>
...
async def protected_endpoint():
    return {"message": "Protected by GuardFlow"}`}</CodeBlock>
        ...
        <section id="installation" className="mb-20">
          <div className="retro-card bg-green-50 border-black p-2 inline-block mb-6">
            <h2 className="text-4xl font-black retro-title text-black flex items-center gap-3">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            <div className="retro-card bg-white border-black p-6">
              <h3 className="text-xl font-black retro-title text-black mb-4">SYSTEM REQUIREMENTS</h3>
              <div className="space-y-3 font-mono text-sm">
                <div className="flex items-center gap-3">
                  <div className="w-4 h-4 bg-green-600 border-2 border-black"></div>
                  <span className="text-gray-700">Python 3.8+</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-4 h-4 bg-green-600 border-2 border-black"></div>
                  <span className="text-gray-700">FastAPI 0.95+</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-4 h-4 bg-green-600 border-2 border-black"></div>
                  <span className="text-gray-700">Redis 4.5+</span>
                </div>
              </div>
            </div>

            <div className="retro-card bg-white border-black p-6">
              <h3 className="text-xl font-black retro-title text-black mb-4">INSTALL FROM PYPI</h3>
          ...
          <div className="retro-card bg-white border-black p-6">
            <h3 className="text-xl font-black retro-title text-black mb-4">DOCKER COMPOSE SETUP</h3>
...
volumes:
  redis_data:`}</CodeBlock>
        ...
        <section id="features" className="mb-20">
          <div className="retro-card bg-purple-50 border-black p-2 inline-block mb-6">
            <h2 className="text-4xl font-black retro-title text-black flex items-center gap-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="retro-card bg-blue-50 border-black p-6">
              ...
              <h3 className="text-2xl font-black retro-title text-black mb-3">DNA FINGERPRINTING</h3>
              ...
              <div className="retro-card-static bg-green-50 border-2 border-green-600 p-3">
                <div className="font-black retro-mono text-xs text-green-800">DETECTION RATE: 99.7%</div>
              </div>
            </div>
            ...
            <div className="retro-card bg-green-50 border-black p-6">
              ...
              <h3 className="text-2xl font-black retro-title text-black mb-3">ZERO-LATENCY</h3>
              <p className="text-gray-700 mb-4 font-mono text-sm">
                Async "fire & forget" telemetry ensures your application performance 
                is never impacted by security processing.
              </p>
              <div className="retro-card-static bg-blue-50 border-2 border-blue-600 p-3">
                <div className="font-black retro-mono text-xs text-blue-800">PROCESSING: &lt;1ms</div>
              </div>
            </div>
            ...
            <div className="retro-card bg-purple-50 border-black p-6">
              ...
              <h3 className="text-2xl font-black retro-title text-black mb-3">PII REDACTION</h3>
              <p className="text-gray-700 mb-4 font-mono text-sm">
                Automatically detects and redacts sensitive data before telemetry 
                leaves your infrastructure. GDPR compliant.
              </p>
              <div className="retro-card-static bg-purple-50 border-2 border-purple-600 p-3">
                <div className="font-black retro-mono text-xs text-purple-800">PRIVACY: ZERO LEAKAGE</div>
              </div>
            </div>

            <div className="retro-card bg-red-50 border-black p-6">
              <div className="retro-card bg-red-600 text-white border-black w-16 h-16 flex items-center justify-center mb-4">
                <span className="text-3xl font-black retro-title">🍯</span>
              </div>
              <h3 className="text-2xl font-black retro-title text-black mb-3">HONEYPOT TRAPS</h3>
              <p className="text-gray-700 mb-4 font-mono text-sm">
                Invisible endpoints that trigger instant global bans when accessed. 
                Catches reconnaissance and automated attacks.
              </p>
              <div className="retro-card-static bg-red-50 border-2 border-red-600 p-3">
                <div className="font-black retro-mono text-xs text-red-800">RESPONSE: INSTANT BAN</div>
              </div>
            </div>
          </div>

          <div className="retro-card bg-yellow-50 border-black p-6 mt-6">
            <h3 className="text-xl font-black retro-title text-black mb-4">HOW DNA FINGERPRINTING WORKS</h3>
            <p className="text-gray-700 mb-4 font-mono text-sm">
...
Fingerprint B: sha256("AC|UA|CN|AL") = "x9y8z7..."`}</CodeBlock>
        ...
        <section id="configuration" className="mb-20">
          <div className="retro-card bg-orange-50 border-black p-2 inline-block mb-6">
            <h2 className="text-4xl font-black retro-title text-black flex items-center gap-3">
          ...
          <div className="retro-card bg-white border-black p-6 mb-6">
            <h3 className="text-xl font-black retro-title text-black mb-4">BASIC CONFIGURATION</h3>
...
app.add_middleware(
    ...
    rate_limit_max_requests=100, # Per window
          ...
          <div className="retro-card bg-white border-black p-6 mb-6">
            <h3 className="text-xl font-black retro-title text-black mb-4">ENVIRONMENT VARIABLES</h3>
...
GUARDFLOW_REDACT_PII=true`}</CodeBlock>
          ...
          <div className="retro-card bg-white border-black p-6">
            <h3 className="text-xl font-black retro-title text-black mb-4">ADVANCED CONFIGURATION</h3>
...
app.add_middleware(
    ...
    webhook_events=["high_threat", "honeypot_trigger"],
        ...
        <section id="deployment" className="mb-20">
          <div className="retro-card bg-red-50 border-black p-2 inline-block mb-6">
            <h2 className="text-4xl font-black retro-title text-black flex items-center gap-3">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            <div className="retro-card bg-white border-black p-6">
              <h3 className="text-xl font-black retro-title text-black mb-4">DOCKERFILE</h3>
...
CMD ["uvicorn", "main:app", "--host", "0.0.0.0", "--port", "8000"]`}</CodeBlock>
            ...
            <div className="retro-card bg-white border-black p-6">
              <h3 className="text-xl font-black retro-title text-black mb-4">KUBERNETES</h3>
    ...
    spec:
      ...
      - name: app
        ...
        - name: GUARDFLOW_API_KEY
          ...
          <div className="retro-card bg-blue-50 border-black p-6">
            <h3 className="text-xl font-black retro-title text-black mb-4">BEST PRACTICES</h3>
            <div className="space-y-3">
              {[
                ...
                <div key={i} className="flex items-start gap-3">
                  <div className="retro-card bg-black border-black w-10 h-10 flex items-center justify-center flex-shrink-0">
                    <span className="text-green-400 font-black text-2xl leading-none">✓</span>
                  </div>
                  <span className="font-mono text-sm text-gray-700 pt-2">{practice}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        {/* CTA Section */}
        <section className="retro-card bg-gradient-to-br from-blue-600 to-purple-600 border-black p-12 text-center">
          <h2 className="text-4xl font-black retro-title text-white mb-4">READY TO PROTECT YOUR APP?</h2>
          <p className="text-lg text-blue-100 mb-8 max-w-2xl mx-auto font-mono">
            Join thousands of developers using GuardFlow to secure their FastAPI applications.
          </p>
          <div className="flex items-center justify-center gap-4 flex-wrap">
            <Link 
              href="/register" 
              className="retro-button bg-white text-black border-black px-8 py-4 hover:bg-gray-100"
            >
            ...
            <Link 
              href="/login" 
              className="retro-button bg-black text-white border-white px-8 py-4 hover:bg-gray-900"
            >
              <span className="font-black retro-mono text-sm">VIEW DASHBOARD</span>
            </Link>
          </div>
          <p className="text-sm text-blue-200 mt-6 font-mono">
