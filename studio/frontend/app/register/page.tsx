...
export default function RegisterPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden px-4 py-10 bg-white">
      ...
      {/* Subtle colorful accents - positioned for register page */}
      <div className="absolute top-1/5 right-1/8 w-36 h-36 opacity-7" style={{
        background: 'linear-gradient(135deg, #ff6b6b18, #4ecdc418)',
        clipPath: 'circle(50% at 50% 50%)',
        filter: 'blur(3px)'
      }}></div>
      
      <div className="absolute bottom-1/3 left-1/7 w-44 h-44 opacity-5" style={{
        background: 'linear-gradient(45deg, #a8edea12, #fed6e312)',
      ...
      <div className="relative z-10 grid w-full max-w-5xl gap-8 lg:grid-cols-[0.95fr_1.05fr]">
        ...
        <div className="border-4 border-black bg-[#fff8dc] p-8 text-black shadow-[14px_14px_0_#000]">
          <div className="mb-8">
            ...
            <p className="mt-2 text-sm text-zinc-700">
              Join GuardFlow Studio to manage your FastAPI security
            </p>
          </div>
        ...
        <div className="border-4 border-black bg-[#14071f] p-8 text-white shadow-[14px_14px_0_#22d3ee]">
          ...
          <p className="mt-4 max-w-md font-mono text-sm text-pink-100/85">
            Create projects, generate API keys, and monitor your FastAPI applications with GuardFlow SDK integration.
          </p>
