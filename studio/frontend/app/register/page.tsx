...
export default function RegisterPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-white p-4 text-black sm:p-6 lg:p-8">
      ...
      <div className="absolute top-32 right-16 retro-card-static bg-white p-3 -rotate-12 hidden xl:block">
        <div className="h-14 w-14 border-4 border-black bg-white">
          <div className="h-full w-full border-4 border-black"></div>
        </div>
      </div>
      <div className="absolute bottom-24 left-16 retro-card-static bg-black p-4 rotate-6 hidden xl:block">
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl">
        ...
        {/* Unconventional zigzag layout */}
        <div className="space-y-4 sm:space-y-6">
          {/* Title - Top right aligned */}
          <div className="flex justify-end">
            <div className="retro-card-static bg-white p-6 sm:p-8 rotate-2 max-w-full sm:max-w-2xl w-full sm:w-auto">
              <div className="absolute inset-0 halftone-subtle"></div>
              <div className="relative z-10">
                <div className="inline-block retro-card-static bg-black px-3 sm:px-4 py-1.5 sm:py-2 mb-3 sm:mb-4 -rotate-3">
          ...
          {/* Google Sign Up - Center featured */}
          <div className="flex justify-center">
            <div className="retro-card-static bg-white p-6 sm:p-8 -rotate-1 max-w-full sm:max-w-xl w-full">
              <div className="absolute inset-0 halftone-subtle"></div>
              <div className="relative z-10">
                <div className="mb-4 sm:mb-5 text-center">
                  <span className="inline-block retro-card-static bg-black px-4 sm:px-5 py-1.5 sm:py-2 text-[10px] sm:text-xs font-black uppercase tracking-[0.3em] rotate-2 text-white">
                    Instant Access
                  </span>
                </div>
                <button
                  ...
                  className="retro-button w-full bg-white px-4 sm:px-6 py-4 sm:py-5 text-xs sm:text-sm font-black uppercase tracking-[0.12em] text-black transition-all hover:-translate-y-1 hover:bg-gray-100 flex items-center justify-center gap-2 sm:gap-3"
                >
                ...
                <p className="mt-3 sm:mt-4 text-[10px] sm:text-xs text-center text-gray-600 retro-mono">
                  Register a GuardFlow account to create projects and manage FastAPI protection
                </p>
              </div>
            </div>
          </div>

          {/* Form - Left aligned with stacked fields */}
          <div className="grid lg:grid-cols-12 gap-4 sm:gap-6">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
                    ...
                    <div className="retro-card-static bg-white p-4 sm:p-5 rotate-1">
                      ...
                      <input
                        ...
                        placeholder="••••••••"
                      />
                      <p className="mt-2 text-[10px] sm:text-xs font-medium uppercase tracking-[0.12em] text-gray-700 retro-mono">
            ...
            <div className="lg:col-span-5 hidden lg:block">
              <div className="retro-card-static bg-white p-5 sm:p-6 -rotate-2">
                <div className="mb-3 text-[10px] font-black uppercase tracking-[0.28em] text-black retro-mono">
                  ONBOARDING
                </div>
                <div className="space-y-4">
                  <div className="retro-card-static bg-white p-3 sm:p-4 rotate-3">
                    <div className="relative h-14 sm:h-16 w-full border-3 border-black bg-white">
                      <div className="absolute left-2 top-2 h-2.5 sm:h-3 w-2.5 sm:w-3 bg-black"></div>
                      <div className="absolute left-6 sm:left-7 top-2 right-2 h-1.5 sm:h-2 bg-black"></div>
                      <div className="absolute left-2 top-7 sm:top-8 h-2.5 sm:h-3 w-2.5 sm:w-3 border-2 border-black bg-white"></div>
                      <div className="absolute left-6 sm:left-7 top-7 sm:top-8 right-2 h-1.5 sm:h-2 bg-black"></div>
                    </div>
                  </div>
                  <div className="text-center text-xl sm:text-2xl font-black">↓</div>
                  <div className="retro-card-static bg-black p-3 sm:p-4 -rotate-3">
                    <div className="relative h-14 sm:h-16 w-full">
                      <div className="absolute left-1/2 top-2 h-4 sm:h-5 w-4 sm:w-5 -translate-x-1/2 rounded-full border-3 border-white bg-black"></div>
          ...
          <div className="flex justify-center">
            <div className="retro-card-static bg-white p-4 sm:p-5 text-center rotate-1 max-w-full sm:max-w-md w-full">
